...
public class GrammarParser extends Parser {
	...
	public static final int
		...
		RULE_functionDeclaration = 3, RULE_parameterList = 4, RULE_block = 5, 
		RULE_statement = 6, RULE_expressionList = 7, RULE_expression = 8, RULE_type = 9;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "structDeclaration", "variableDeclaration", "functionDeclaration", 
			"parameterList", "block", "statement", "expressionList", "expression", 
			"type"
		};
	}
