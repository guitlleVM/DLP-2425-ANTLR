...
public class ExceptionThrowerVisitor implements Visitor {
	...
	public Object visit(StructDeclaration structDeclaration, Object param) {
        ...
        throw new UnsupportedOperationException("'ExceptionThrowerVisitor.visit(StructDeclaration)' has been invoked but it has not been implemented.");
	}
	...
	public Object visit(VariableDeclaration variableDeclaration, Object param) {
        ...
        throw new UnsupportedOperationException("'ExceptionThrowerVisitor.visit(VariableDeclaration)' has been invoked but it has not been implemented.");
	}

	@Override
	public Object visit(FunctionDeclaration functionDeclaration, Object param) {

        throw new UnsupportedOperationException("'ExceptionThrowerVisitor.visit(FunctionDeclaration)' has been invoked but it has not been implemented.");
	}
	...
	public Object visit(FuncionLlamada funcionLlamada, Object param) {
        ...
        throw new UnsupportedOperationException("'ExceptionThrowerVisitor.visit(FuncionLlamada)' has been invoked but it has not been implemented.");
	}
	...
	public Object visit(ExpresionLlamada expresionLlamada, Object param) {
        ...
        throw new UnsupportedOperationException("'ExceptionThrowerVisitor.visit(ExpresionLlamada)' has been invoked but it has not been implemented.");
	}
	...
	public Object visit(ExpresionAritmetica expresionAritmetica, Object param) {
        ...
        throw new UnsupportedOperationException("'ExceptionThrowerVisitor.visit(ExpresionAritmetica)' has been invoked but it has not been implemented.");
	}

	@Override
	public Object visit(ExpresionLogica expresionLogica, Object param) {

        throw new UnsupportedOperationException("'ExceptionThrowerVisitor.visit(ExpresionLogica)' has been invoked but it has not been implemented.");
	}
	...
	public Object visit(LitEnt litEnt, Object param) {
        ...
        throw new UnsupportedOperationException("'ExceptionThrowerVisitor.visit(LitEnt)' has been invoked but it has not been implemented.");
	}

	@Override
	public Object visit(LitReal litReal, Object param) {

        throw new UnsupportedOperationException("'ExceptionThrowerVisitor.visit(LitReal)' has been invoked but it has not been implemented.");
	}

	@Override
	public Object visit(LitChar litChar, Object param) {

        throw new UnsupportedOperationException("'ExceptionThrowerVisitor.visit(LitChar)' has been invoked but it has not been implemented.");
	}
